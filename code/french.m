...
%   FLAG can be either 1 (default), 2 or 3.
%
...
%
% Revision 2.3  2011/08/30 19:45:00  evers
% Added a third flag (narrower white space)
%
...
switch flag
    ...
    case 3
        c = interp1([-1;0;1], [1,0,0;1,1,1;0,0,1], (-1:0.02:1));
        r = c(:,1); g = c(:,2); b = c(:,3);
end
